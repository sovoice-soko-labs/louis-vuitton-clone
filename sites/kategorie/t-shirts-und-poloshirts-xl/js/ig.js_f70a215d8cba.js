...
w["_insideCluster"] = "eu7";
w["_insideGraphUrl"] = w["_insideProtocol"] + "www7.eu.inside.chat/";
w["_insideSocialUrl"] = w["_insideProtocol"] + "www7.eu.inside.chat/";
w["_insideCDN"] = w["_insideProtocol"] + "cdn7.eu.inside.chat/";
w["_insideCDN2"] = "cdn7.eu.inside.chat/";
w["_insideScriptVersion"] = "509cafb664-137832";
w["_insideLive"] = true;
...
w["_insideDisableLongPolling"] = true;
    ...
    function videoChatSupported(callback) {
        ...
        try {
            var androidMobile = (navigator.userAgent.match(/Android/g) ? true : false);
            var isSDK = navigator.appVersion.indexOf("InsideMobileAndroid") !== -1;
            if (isSDK && androidMobile) {
                callback(true, true);
                return;
            }
        } catch (e) {
